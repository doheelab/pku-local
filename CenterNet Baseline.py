...
os.chdir('/home/dohee/kaggle/Peking/code')
...
class MyUNet(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.base_model = EfficientNet.from_pretrained('efficientnet-b3') # -b0
        ...
        self.up1 = up(1538 + 1024, 512) # b0, b1: 1282, b2:1410, b3: 1538
...
test.to_csv('predictions_b0.csv', index=False)
test.head()
